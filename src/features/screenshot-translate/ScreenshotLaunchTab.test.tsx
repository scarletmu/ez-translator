...
describe('ScreenshotLaunchTab', () => {
  it('shows settings guide when config is missing', () => {
    render(<ScreenshotLaunchTab configStatus={{ textTranslateReady: true, screenshotTranslateReady: false }} targetLang="zh-CN" />);
  ...
  it('starts screenshot mode when ready', async () => {
    ...
    render(<ScreenshotLaunchTab configStatus={{ textTranslateReady: true, screenshotTranslateReady: true, screenshotMode: 'direct_multimodal' }} targetLang="ja" />);
  ...
  it('shows launch error and settings CTA when permission is missing', async () => {
    ...
    render(<ScreenshotLaunchTab configStatus={{ textTranslateReady: true, screenshotTranslateReady: true, screenshotMode: 'direct_multimodal' }} targetLang="zh-CN" />);
