...
describe('PasteTranslateTab', () => {
  it('shows settings guide when config is missing', () => {
    render(<PasteTranslateTab configStatus={{ textTranslateReady: false, screenshotTranslateReady: false }} defaultTargetLang="zh-CN" />);
  ...
  it('shows loading state while translating', async () => {
    ...
    render(<PasteTranslateTab configStatus={{ textTranslateReady: true, screenshotTranslateReady: false }} defaultTargetLang="zh-CN" />);
